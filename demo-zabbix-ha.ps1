<#
.SYNOPSIS
  Prepara e opera o lab Zabbix HA para apresentaÃ§Ã£o em Windows/PowerShell.
...
'@
    ...
    Write-Ok 'docker-compose.yml e nginx/default.conf atualizados para o cenÃ¡rio fake-prod.'
}
...
function Invoke-ZabbixApi {
    ...
    $response = Invoke-RestMethod `
        -Uri 'http://localhost:8080/api_jsonrpc.php' `
        -Method Post `
        -Headers $headers `
